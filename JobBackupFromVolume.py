...
archives.append('/Users/Matt/Volumes/1TB ARCHIVE/')
archives.append('/Users/Matt/Volumes/1TB ARCHIVE BUP/')

################################################################################
# Define Other Constants
################################################################################

pathToVolumes = '/Users/Matt/Volumes/'

file_extensions_filter = ('JPG', 'MTS', 'CR2', 'DNG', 'MOV', 'MP4')
